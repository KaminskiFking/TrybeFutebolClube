...
- Você deve criar uma branch no seguinte formato: `nome-de-usuario-nome-do-projeto`
  * Exemplo: `git checkout -b maria-sd-023-b-trybe-futebol-clube`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-023-b-trybe-futebol-clube`
...
- `sd-023-b-trybe-futebol-clube/app/backend/package.json`
